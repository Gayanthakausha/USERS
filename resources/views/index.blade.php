          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-caption">
              ...
              <h5>Your Health Is Our Happiness</h5>
                    <p>Lorem ipsum dolor sit amet pamudu Fernando, Kalindu Abey gimhani, consectetur adipisicing elit. Maxime, nulla, tempore. Deserunt excepturi quas vero.
                    </p>
            </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="carousel-caption">
              ...
              <h5>Always Dedicated</h5>
                              <p>Lorem ipsum dolor malkaa sit amet, consectetur adipisicing elit. Maxime, nulla, tempore. Deserunt excepturi quas vero.</p>
                    ...
                    <div class="card text-light text-center bg-white pb-2">
                        <div class="card-body text-dark">
                          <div class="img-area mb-4">
                            ...
                            <h3 class="card-title">3 Days free</h3>
                            <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci eligendi modi temporibus alias iste. Accusantium?</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card text-light text-center bg-white pb-2">
                        <div class="card-body text-dark">
                          <div class="img-area mb-4">
                            ...
                            <h3 class="card-title">Nurse's Package</h3>
                            <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci eligendi modi temporibus alias iste. Accusantium?</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card text-light text-center bg-white pb-2">
                        <div class="card-body text-dark">
                          <div class="img-area mb-4">
                            ...
                            <h3 class="card-title">patient's Package</h3>
                            <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci eligendi modi temporibus alias iste. Accusantium?</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container mt-5 mb-5">
			...
			<div class="row m-0">
				<div class="col-md-12 p-0 pt-4 pb-4">
                    <div class="col-md-12 p-0 pt-4 pb-4" style="background-color: rgba(255, 166, 0, 0.808)">
                    <h3 style="text-align: center">H.Y.G.K.Jayasena</h3><br>
                    <h3 style="text-align: center">gkjayasena123@gmail.com</h3>
                    </div>
				</div>
			</div>
		</div>
    ...
    <footer class="bg-dark p-2 text-center">
        <div class="container">
            <p class="text-white">All Right Reserved By @Carelink</p>
        </div>
    </footer>
